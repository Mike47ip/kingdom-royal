// app/my-booking/MyBookingContent.jsx
'use client'
    ...
    <div className="min-h-screen bg-cream">
      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        <div className="mb-10 animate-fade-up">
          <h1
            className="font-[family-name:var(--font-outfit)] text-charcoal font-semibold leading-tight mb-2"
        ...
        {enquiry && (
          <div className="space-y-4 animate-fade-in">
            ...
            <div className="bg-white p-5 shadow-[0_2px_16px_rgba(26,26,26,0.06)]">
              <h3
                className="text-base text-charcoal font-semibold mb-4"
                style={{ fontFamily: 'var(--font-outfit)' }}
              >
                Enquiry Details
              </h3>
