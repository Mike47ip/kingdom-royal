  ...
  return (
    <div className="min-h-screen bg-charcoal flex flex-col items-center justify-center px-6 py-16 relative overflow-hidden">
      ...
      >
        ...
        <h1
          className="font-[family-name:var(--font-playfair)] text-white font-normal leading-tight mb-4"
        ...
        <div className="bg-white/5 border border-gold/30 p-7 mb-8">
          ...
          <p className="font-[family-name:var(--font-playfair)] text-gold text-3xl tracking-widest mb-4">{enquiryNumber}</p>
          <button
            onClick={copy}
        ...
        <div className="flex gap-3 justify-center flex-wrap">
          ...
          <button onClick={() => router.push('/')} className="btn-outline-white text-[0.72rem]">
            Back to Hotels
          </button>
        </div>
